...
cmd(
  ...
  async (hansa, mek, m, { from, reply }) => {
    ...
    await hansa.sendMessage(from, { text: `💬 "${data.quote}"\n- ${data.character} (${data.anime})` }, { quoted: mek });
  }
);
...
cmd(
  ...
  async (hansa, mek, m, { from }) => {
    ...
    await hansa.sendMessage(from, { text: `🤔 *Anime Fact:* ${fact}` }, { quoted: mek });
  }
);
...
cmd(
  ...
  async (hansa, mek, m, { from }) => {
    ...
    await hansa.sendMessage(from, { text: `❓ *Quiz:* ${selected.q}\n_Answer: ${selected.a}_` }, { quoted: mek });
  }
);
...
cmd(
  ...
  async (hansa, mek, m, { from }) => {
    ...
    await hansa.sendMessage(from, { video: { url: gif }, caption: "🎲 Anime Roll" }, { quoted: mek });
  }
);
...
cmd(
  ...
  async (hansa, mek, m, { from }) => {
    ...
    await hansa.sendMessage(from, { image: { url: selected.url }, caption: "🎮 Guess this character!" }, { quoted: mek });
  }
);
